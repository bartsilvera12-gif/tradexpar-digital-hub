-- TRADEXPAR — Fastrax: columnas externas, check product_source_type, índices (idempotente).
-- Equivale a supabase/tradexpar_fastrax_catalog.sql para `supabase db push` / migraciones CLI.
